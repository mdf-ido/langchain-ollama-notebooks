...
class Config:
    ...
    def __init__(self):
        self.ollama_base_url = os.getenv("OLLAMA_BASE_URL", "http://192.168.1.82:11434")
        self.model_name = os.getenv("OLLAMA_DEFAULT_MODEL", "qwen3:14b")  # Changed from default_model to model_name
